...
/* =================================================================
   ...
   TO ADD IMAGE:      Set image: "images/yourfile.jpeg" — also works with .jpg .png .webp
...
const products = [
  ...
  {
    id: 1,
    name: "HEPU HP-235 All-in-One Power Bank",
    ...
    badge: "hot",
    soldOut: false,
    desc: "20,000mAh · 22.5W Qualcomm Quick Charge · 4 built-in connectors · Woven texture · Only 241g.",
    rating: 4.8
  },
  {
    id: 2,
...
function openProduct(id) {
  ...
  if (id === 4) { window.location.href = "powerbank.html"; return; }
  if (id === 1) { window.location.href = "hepu.html"; return; }
  if (id === 2) { window.location.href = "aldeepo.html"; return; }
...
function placeOrder() {
  ...
  //
  var SHEET_URL = "https://script.google.com/macros/s/AKfycbwO23zcasbNW2oVu-z4vQ9j7bjh5qjsZKKZ7DcXtI-diPrQbjQb2gxsBEHcnqpsHuIA/exec";
  //
